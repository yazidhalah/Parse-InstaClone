...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        let config = ParseClientConfiguration { (ParseMutableClientConfiguration) in
            ...
            ParseMutableClientConfiguration.applicationId = "yWU1x1xcBgOtbmXP3uzgrS5hL6UtKK20bo1haTcj"
            ParseMutableClientConfiguration.clientKey = "mfwF5sp22AzDnRqxlUeCPW9Zv7Di7ump7DkagLRe"
